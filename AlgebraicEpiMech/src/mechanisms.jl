...
The `schema` argument determines the population types used.
"""
function add_infection!(
        uwd, infectee_junction, infector_junction,
        first_infected_junction, schema::OnePopulationSchema
    )
...
function add_infection!(
        uwd, infectee_junction, infector_junction,
        first_infected_junction, schema::UninfectedInfectedSchema
    )
...
function add_disease_progression!(
        uwd, from_junction, to_junction, schema::OnePopulationSchema
    )
    pop_type = schema.population_type
...
function add_disease_progression!(
        uwd, from_junction, to_junction, schema::UninfectedInfectedSchema
    )
    pop_type = schema.infected_type
...
function add_uninfected_density_progression!(
    ...
    pop_type = schema.uninfected_type
